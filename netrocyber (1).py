...
os.system("cls")
power = 68
os.system(f"title NetroCyber DDOS Is Beta Version [ Please Wait Next Uptade ] power : [{power}%] [ DONT LEAK THIS TOOLS DDOS OR WE TAKE YOUR VPS ]")
...
os.system("cls")
print("╔═════════════════════════════════════════════════╗")
print("║ [+] Tools V4 Created By X-Netro                 ║")
print("║ [-] This Tools Was Copyright X-Netro            ║")
print("║                                                 ║")
print("║ ███╗░░██╗███████╗████████╗██████╗░░█████╗░      ║")
print("║ ████╗░██║██╔════╝╚══██╔══╝██╔══██╗██╔══██╗      ║")
print("║ ██╔██╗██║█████╗░░░░░██║░░░██████╔╝██║░░██║      ║")
...
port = int(input("╚════> "))
print("")
print("╔══[METHOD@X-Netro]")
method = str(input("╚════> "))
print("")
print("╔══[PACKETS@X-Netro]")
times = int(input("╚════> "))
print("")
print("╔══[THREADS@X-Netro]")
threads = int(input("╚════> "))
time.sleep(5)
os.system("cls")
print("                ATTACK SENT                   ")
...
print("║ IP             = " + ip  + " ")                  
print("║ METHOD         = " + method  + " ")                       
print("║ Copyright      = " + "X-NetroGanz" + " ")                             
print("╚═══════════════════════════════════════════════╝")
time.sleep(3)
print("")
print("╔══[INFO@X-Netro]")
print("╚════> NetroCyber DDOS IS BETA VERSION THE POWER IS NOT POWERFULL PLEASE WAIT NEXT UPTADE")
print("")
